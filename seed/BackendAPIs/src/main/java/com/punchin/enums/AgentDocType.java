...
public enum AgentDocType {
    ...
    FIR_REPORT(7, "FIR_REPORT"),
    POSTMORTEM_REPORT(7, "POSTMORTEM_REPORT"),
    ...
    STAMPED_AFFIDAVIT(26, "STAMPED_AFFIDAVIT"),
    ANY_UTILITY_BILL(26, "ANY_UTILITY_BILL"),
    MEDICAL_ATTENDANT_CERTIFICATE(26, "MEDICAL_ATTENDANT_CERTIFICATE");
