...
public interface ClaimsDataRepository extends JpaRepository<ClaimsData, Long> {
    ...
    List<ClaimsData> findBankerClaimSearchedDataByClaimDataId1(@Param("searchedKeyword") String searchedKeyword, Long bankerId, Pageable pageable);

    @Query(nativeQuery = true, value = "select * from claims_data cd where cd.claim_status in ('IN_PROGRESS','VERIFIER_DISCREPENCY','AGENT_ALLOCATED', " +
            "'ACTION_PENDING','CLAIM_SUBMITTED','CLAIM_INTIMATED','UNDER_VERIFICATION') and cd.loan_account_number Ilike %:searchedKeyword% and cd.banker_id=:bankerId ")
    List<ClaimsData> findAllBankerClaimSearchedDataByClaimDataId2(@Param("searchedKeyword") String searchedKeyword, Long bankerId, Pageable pageable);

    @Query(nativeQuery = true, value = "select * from claims_data cd where cd.claim_status in ('IN_PROGRESS','VERIFIER_DISCREPENCY','AGENT_ALLOCATED', " +
            "'ACTION_PENDING','CLAIM_SUBMITTED','CLAIM_INTIMATED','UNDER_VERIFICATION') and (cd.borrower_name Ilike %:searchedKeyword%) and cd.banker_id=:bankerId ")
    List<ClaimsData> findAllBankerClaimSearchedDataByClaimDataId3(@Param("searchedKeyword") String searchedKeyword, Long bankerId, Pageable pageable);
    ...
    List<ClaimsData> findBankerClaimSearchedDataByClaimDataId(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, Long bankerId, Pageable pageable);
    ...
    List<ClaimsData> findBankerClaimSearchedDataByLoanAccountNumber(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, Long bankerId, Pageable pageable);
    ...
    List<ClaimsData> findBankerClaimSearchedDataBySearchName(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, Long bankerId, Pageable pageable);
    ...
    List<ClaimsData> findVerifierClaimSearchedDataByClaimDataId(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, String state);
    ...
    List<ClaimsData> findVerifierClaimSearchedDataByLoanAccountNumber(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, String state);
    ...
    List<ClaimsData> findVerifierClaimSearchedDataBySearchName(@Param("searchedKeyword") String searchedKeyword, List<String> claimStatus, String state);
    ...
    @Query(nativeQuery = true, value = "select * from claims_data cd where cd.claim_status in ('IN_PROGRESS','VERIFIER_DISCREPENCY','AGENT_ALLOCATED', " +
            " 'ACTION_PENDING','CLAIM_SUBMITTED','CLAIM_INTIMATED','UNDER_VERIFICATION') and cd.borrower_state=:state and cd.punchin_claim_id Ilike %:searchedKeyword% ")
    List<ClaimsData> findAllocateClaimSearchedDataByClaimDataId(String searchedKeyword, String state);

    @Query(nativeQuery = true, value = "select * from claims_data cd where cd.claim_status in ('IN_PROGRESS','VERIFIER_DISCREPENCY','AGENT_ALLOCATED', " +
            " 'ACTION_PENDING','CLAIM_SUBMITTED','CLAIM_INTIMATED','UNDER_VERIFICATION') and cd.borrower_state=:state and cd.loan_account_number Ilike %:searchedKeyword% ")
    List<ClaimsData> findAllocateClaimSearchedDataByLoanAccountNumber(String searchedKeyword, String state);
    ...
    List<ClaimsData> findAllocateSearchedDataBySearchName(String searchedKeyword, String state);
}
