...
public class AgentServiceImpl implements AgentService {
    ...
    public   List<AgentSearchDTO1> getClaimSearchedData(SearchCaseEnum searchCaseEnum, String searchedKeyword, Integer pageNo, Integer limit, ClaimDataFilter claimDataFilter) {
        ...
        List<AgentSearchDTO1> agentSearchDTO1s = ObjectMapperUtils.mapAll(claimSearchedData.toList(), AgentSearchDTO1.class);
        for(AgentSearchDTO1 agentSearchDTO1:agentSearchDTO1s){
